...
export function TimerTicker() {
  ...
  return (
    <div className="fixed bottom-16 md:bottom-4 right-4 z-50 flex items-center gap-3 rounded-xl border border-blue-200 dark:border-blue-900 bg-white/95 dark:bg-gray-900/95 px-4 py-2.5 shadow-2xl backdrop-blur-md animate-in slide-in-from-bottom-5">
